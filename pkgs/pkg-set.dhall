            ...
            ⫽ { pkgUrl =
              ...
              , configureCommand =
                  ...
                  → let sharedFlag =
                    ...
                    let targetMakefile =
                          if cfg.isCross then "gcc" else "linux-x86_64"
            ...
            in    prelude.simplePackage
                ...
                ⫽ { pkgUrl =
                  ...
                  , pkgDeps =
                      ...
                      , prelude.lowerBound
                          { name = "atk", lower = [ 1, 29, 2 ] }
                      , prelude.lowerBound
                          { name = "glib", lower = [ 2, 28, 0 ] }
                      , prelude.lowerBound
...
let xproto = mkXProtoWithPatch "xproto" ./patches/xproto.patch as Text
        ...
        in    prelude.simplePackage
            ...
            ⫽ { pkgUrl =
              ...
              , pkgDeps =
                  ...
                  , prelude.lowerBound
                      { name = "fribidi", lower = [ 0, 19, 7 ] }
                  , prelude.lowerBound
                      { name = "harfbuzz", lower = [ 1, 4, 2 ] }
...
let xextproto = mkXProtoWithPatch "xextproto" ./patches/xextproto.patch as Text
...
let at-spi-atk =
      ...
      →   mkGnomeNinja "at-spi2-atk" x
        ⫽ { pkgDeps =
              [ prelude.lowerBound
                  { name = "at-spi2-core", lower = [ 2, 32, 2 ] }
      ...
      →   prelude.makeGnuExe { name = "make", version = v }
        ⫽ { pkgUrl =
              "https://ftp.wayne.edu/gnu/make/make-${prelude.showVersion
                                                       v}.tar.bz2"
          , configureCommand =
              prelude.configureWithPatch ./patches/make.patch as Text
          , buildCommand =
                λ(cfg : types.BuildVars)
              → [ prelude.call
                    (   prelude.defaultCall
      ...
      → let versionString =
        ...
        in    prelude.simplePackage
            ...
            ⫽ { pkgUrl =
              ...
              , pkgDeps =
                  [ prelude.lowerBound
                      { name = "freetype", lower = [ 9, 10, 3 ] }
                  , prelude.lowerBound
                      { name = "fribidi", lower = [ 0, 19, 0 ] }
                  , prelude.lowerBound
                      { name = "harfbuzz", lower = [ 0, 9, 5 ] }
                  , prelude.lowerBound
